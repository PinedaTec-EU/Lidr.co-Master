...
The report directory can be changed from the sidebar. The selector offers known local report folders and a manual path input for validating reports generated by other repositories without changing `.env`.
